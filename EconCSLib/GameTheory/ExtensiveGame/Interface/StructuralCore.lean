...
The narrow stable import for the payoff-free structural semantics of
extensive games. It exposes only the Arena dynamics, controlled dynamics,
finite reachability, typed histories, measure-free complete plays, and the
payoff-free controlled information/strategy carrier.
...
`Interface.Core` remains the broader stable Foundation Facade for clients that
also need finite/recall/subgame certificates and bounded deterministic/PMF
execution.
-/
