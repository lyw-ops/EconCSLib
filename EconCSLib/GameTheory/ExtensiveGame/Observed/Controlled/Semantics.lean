...
belong to concrete pure, behavioral, or path-law execution layers until those
layers expose a common canonical root-local strategy and execution interface.
