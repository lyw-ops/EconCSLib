...
specification. [`MANUAL_ZH.md`](MANUAL_ZH.md) is explanatory and cannot
override the English text. [`TAXONOMY.md`](TAXONOMY.md) is a human-readable
index; rule identity remains defined by
...
- [`MANUAL_ZH.md`](MANUAL_ZH.md): explanatory Chinese translation.
...
- [`VERSION.md`](VERSION.md): independent version identities and migration
  status.
- [`REPOSITORY_INTEGRATION_ZH.md`](REPOSITORY_INTEGRATION_ZH.md): architecture
  conclusion, Phase 1 completion status, validation, and scope boundary.
- [`PHASE1_COMPLETION_REPORT_ZH.md`](PHASE1_COMPLETION_REPORT_ZH.md): auditable
...
- [`PHASE3_COMPLETION_REPORT_ZH.md`](PHASE3_COMPLETION_REPORT_ZH.md): Phase 3
  finding disposition, version boundary, changed/unchanged paths, validation,
  and Phase 4 handoff.
- [`PHASE4_COMPLETION_REPORT_ZH.md`](PHASE4_COMPLETION_REPORT_ZH.md): Phase 4
